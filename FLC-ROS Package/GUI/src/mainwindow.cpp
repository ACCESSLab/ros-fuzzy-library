    ...
    ui(new Ui::MainWindow)
{
    ...
    XMLReader Mgr(&m_stData);//No this is great. But My plan was to read the data to be used by other classes. Let me show u something
    Mgr.ReadXMLFile("TestXMLFinal.xml");
}
